...
const VihvaWeb = () => {
  ...
  return (
    <>
          ...
          <section ref={el => sectionsRef.current[1] = el} className='secaoHorizontal hidden'>
            <div className='conteudoHorizontal'>
              ...
              <div>
                ...
                <img className='logoLinguagensH' src={html} alt="HTML Logo" />
              </div>
            </div>
          </section>
          ...
          <div style={{ backgroundColor: '#6196A8' }}>
            ...
            <section ref={el => sectionsRef.current[4] = el} className='AprendizadosHorizontal hidden'>
              <div className='containerAprendizados'>
                ...
                <p className='aprendizadosText'>O desenvolvimento do Vihva foi meu primeiro projeto utilizando React, proporcionando uma excelente oportunidade para expandir significativamente minhas habilidades em HTML, CSS e JavaScript. Além disso, a integração do Firebase como banco de dados foi fundamental para aprimorar meus conhecimentos em soluções de backend, consolidando uma experiência prática e enriquecedora no desenvolvimento web.</p>
              </div>
            </section>
      ...
      {/* ---------------------------------- MOBILE ----------------------------- */}
      <div className='vihvawebMobContainer'>
        <div className="containerTituloMob" ref={el => mobileSectionsRef.current[0] = el}>
          <h1 style={{fontSize: '6rem'}} className="TituloContainerMob">Vihva Medical Center</h1>
        </div>
        <section>
          <div className='topoHomeMob' ref={el => mobileSectionsRef.current[1] = el}>
            <img className='imagemVihvaappMob' src={vihvaApp} alt="Vihva App" />
            <div className='topoHomeMob'>
              <p className='euVihvaMob'>O Vihva Medical Center é uma plataforma inovadora que apoia médicos no acompanhamento contínuo de pacientes com doenças crônicas. Com o aplicativo Android Vihva, profissionais de saúde monitoram a saúde diária dos pacientes, oferecendo atendimento personalizado e eficiente, assegurando controle rigoroso e preciso das condições ao longo do tempo.</p>
              <h2 className='linguagensMob'>Linguagens Utilizadas</h2>
              <img style={{width: '40%'}} className='logoLinguagensMob' src={html} alt="Kotlin Logo" />
            </div>
          </div>
        </section>
        <img className='waveazulh' ref={el => mobileSectionsRef.current[2] = el} src={waves} alt="Wave" />
        <div style={{ backgroundColor: '#6196A8' }} ref={el => mobileSectionsRef.current[3] = el}>
          ...
          <p className='aprendizadosVihvaMob ' ref={el => mobileSectionsRef.current[9] = el}>O desenvolvimento do Vihva foi meu primeiro projeto utilizando React, proporcionando uma excelente oportunidade para expandir significativamente minhas habilidades em HTML, CSS e JavaScript. Além disso, a integração do Firebase como banco de dados foi fundamental para aprimorar meus conhecimentos em soluções de backend, consolidando uma experiência prática e enriquecedora no desenvolvimento web.</p>
          <div className="buttonsHorizontal " ref={el => mobileSectionsRef.current[10] = el}>
